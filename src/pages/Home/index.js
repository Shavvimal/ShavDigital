    ...
    <section id="homesect" className="slide1 text-white">
      <div className=" w-full h-full flex  flex-wrap">
        ...
        <div className="w-full lg:w-1/2 flex flex-col ">
          <div
            id="slide-1-content-left"
            className="contentLeft"
            ref={(el) => (contentLeft = el)}
            className="flex flex-col justify-center lg:justify-start my-auto pt-8 lg:pt-0 px-8 lg:px-24 lg:px-32 "
          >
            <h1 className="text-center lg:text-left text-6xl lg:text-4xl">
              Welcome! My name is{" "}
              <span className="accentorange">Shav Vimalendiran</span> and I'm an
              AI & Data Scientist at Apollo SaturnF1.
            </h1>
          </div>
        </div>
        ...
        <div
          ...
          ref={(el) => (contentRight = el)}
          className="w-1/2"
        >
          <div className=" absolute object-fit w-full h-full hidden lg:block">
            <NavLink smooth to={"/#portfoliosect"} activeClassName="">
              <div
                className="flex flex-row sizebub pos-bub-1 "
                id="bubble1parent"
              >
                <img
                  className="bubble1Anim1"
                  ref={(el) => (bubble1Anim1 = el)}
                  id="bubble1main"
                  className="w-full h-full  absolute bubble1"
                  src={mainBubble}
                  alt="mainBubble1"
                />

                <svg
                  className="bubble1Anim2"
                  ref={(el) => (bubble1Anim2 = el)}
                  id="icon1"
                  fill="white"
            ...
            <NavLink smooth to={"/#contactsect"} activeClassName="">
              <div
                id="bubble"
                className=" flex flex-row  sizebub pos-bub-2 "
                id="bubble2parent"
              >
                <img
                  ...
                  id="bubble2main"
                  className="w-full h-full  absolute bubble2"
                  src={mainBubble}
                  alt="mainBubble1"
                />

                <svg
                  className="bubble2Anim2"
                  ref={(el) => (bubble2Anim2 = el)}
                  id="icon2"
                  fill="white"
                  className="w-full h-full"
                  viewBox="0 0 512 512"
            ...
            <NavLink smooth to={"/#Techsect"} activeClassName="">
              <div
                className="  flex flex-row  sizebub pos-bub-3 "
                id="bubble3parent"
              >
                <img
                  className="bubble3Anim1"
                  ref={(el) => (bubble3Anim1 = el)}
                  id="bubble3main"
                  className="w-full h-full bubble3 absolute"
                  src={mainBubble}
                  alt="mainBubble1"
                />

                <svg
                  className="bubble3Anim2"
                  ref={(el) => (bubble3Anim2 = el)}
                  id="icon3"
                  fill="white"
                  className="w-full h-full"
                  viewBox="0 0 512 512"
            ...
            <NavLink smooth to={"/#AboutSect"} activeClassName="">
              <div
                className="  flex flex-row  sizebub pos-bub-4 "
                id="bubble4parent"
              >
                <img
                  className="bubble4Anim1"
                  ref={(el) => (bubble4Anim1 = el)}
                  id="bubble4main"
                  className="w-full h-full  bubble4 absolute"
                  src={mainBubble}
                  alt="mainBubble1"
                />

                <svg
                  className="bubble4Anim2"
                  ref={(el) => (bubble4Anim2 = el)}
                  id="icon4"
                  fill="white"
                  className="w-full h-full"
                  viewBox="0 0 512 512"
          ...
          <svg
            ...
            className="object-fit w-full h-screen hidden lg:block"
            xmlnsXlink="http://www.w3.org/1999/xlink"
            viewBox="0 0 302.4 266.88"
          >
            <defs>
              ...
              <clipPath
                id="b92a3f7d-b0d0-4785-9f42-509385dbf4bb"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="141.02"
                  cy="132.71"
              ...
              <clipPath
                id="eaece23f-472e-44d5-924e-3f82631c47c1"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="82.76"
              ...
              <clipPath
                id="a2e5ab2e-98c7-44a1-96f5-7c5d6cafe8c1"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="208.03"
              ...
              <clipPath
                id="afcd7789-494e-4797-94bc-053ac8408190"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="173.64"
              ...
              <clipPath
                id="ead91274-6277-49f4-adde-014dc9fc3ecb"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="96.21"
              ...
              <clipPath
                id="f56dc1bd-e6c1-4656-b78e-5579643caf8c"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="52.95"
              ...
              <clipPath
                id="ab593b6e-c654-4a7d-9fa9-d77d58073eab"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="202.3"
              ...
              <clipPath
                id="b1a15e22-f370-4c5f-9226-6b6f7d1c2b7e"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="191.19"
              ...
              <clipPath
                id="ef3958a2-412a-4f24-9c2b-e28cd6e099f2"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="208.05"
              ...
              <clipPath
                id="b671e4a1-a526-47ce-99a5-a3f78261f1b0"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="190.69"
              ...
              <clipPath
                id="e1f94fd5-e8dd-4154-a8fb-96e4b94fae9d"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="173.24"
              ...
              <clipPath
                id="b6dbe08e-f00e-48ee-92b0-7f9ca9311791"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="160.03"
              ...
              <clipPath
                id="e843966a-0f71-4ee6-833b-1428ad798fae"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="50.15"
              ...
              <clipPath
                id="bb63bc3f-f444-4db8-b975-4ecf8cd4d8ac"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="30.49"
              ...
              <clipPath
                id="a6e539fb-1373-43c5-a9fc-830e50c11563"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="273.13"
              ...
              <clipPath
                id="e7102751-cffc-469b-93dd-04a703b88b3f"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="259.71"
              ...
              <clipPath
                id="ab98e40e-35ed-4023-a9cc-cbf16348126d"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="279.66"
              ...
              <clipPath
                id="bedf93e2-2f3c-41a8-bf96-b737d9b454c4"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="262.06"
              ...
              <clipPath
                id="f329aa81-4401-443a-8edd-eda867cf3faf"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="42.2"
              ...
              <clipPath
                id="ab868cb3-2278-4a94-8c9a-3d2e8e6682e5"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="31.22"
              ...
              <clipPath
                id="a8b3c531-4800-4fa7-8e6b-7c93af7ac366"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="263.59"
              ...
              <clipPath
                id="b34c1b5b-dc78-465b-9f5f-d9b9896d3657"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="249.21"
              ...
              <clipPath
                id="a37c5fb9-3f04-481e-b0a7-dd2b391e79f1"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="17.32"
              ...
              <clipPath
                id="fc997408-5ede-40c0-a675-a15b1046eb37"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="-4.99"
              ...
              <clipPath
                id="e416c6fc-9e73-4ffa-b311-731ce35f3208"
                transform="translate(5.05 5.02)"
              >
                <circle
                  cx="259.21"
              ...
              <clipPath
                id="f6e009af-8eb6-4b07-ab1f-8e0f9e8ebf45"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="244.44"
              ...
              <clipPath
                id="a175f790-81a9-4634-b0ce-5161332adf56"
                transform="translate(5.05 5.02)"
              >
                <circle cx="53.05" cy="6.7" r="6.7" style={{ fill: "none" }} />
              </clipPath>
              <clipPath
                id="aebeb1e5-e234-4597-8d0d-525ee31aa038"
                transform="translate(5.05 5.02)"
              >
                <rect
                  x="41.35"
            ...
            <g id="ef94a1c8-e1ca-4a3e-9847-994abd739408" data-name="Layer 2">
              <g id="bcbaf18a-14bd-45a0-aa43-22a3a58337d6" data-name="Layer 1">
                <g
                  id="bubble5"
                  className="bubble5Anim1"
                  ref={(el) => (bubble5Anim1 = el)}
                  data-name="11"
                >
                  <g
                    style={{
                      clipPath: "url(#ab593b6e-c654-4a7d-9fa9-d77d58073eab)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#b1a15e22-f370-4c5f-9226-6b6f7d1c2b7e)",
                      }}
                    >
                      <image
                        width="48"
                        height="47"
                        transform="translate(195.84 47.52) scale(0.48)"
                ...
                <g
                  id="bubble6"
                  className="bubble6Anim1"
                  ref={(el) => (bubble6Anim1 = el)}
                  data-name="10"
                >
                  <g
                    style={{
                      clipPath: "url(#ef3958a2-412a-4f24-9c2b-e28cd6e099f2)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#b671e4a1-a526-47ce-99a5-a3f78261f1b0)",
                      }}
                    >
                      <image
                        width="74"
                        height="73"
                        transform="translate(195.36 56.16) scale(0.48)"
                ...
                <g
                  id="bubble7"
                  className="bubble7Anim1"
                  ref={(el) => (bubble7Anim1 = el)}
                  data-name="9"
                >
                  <g
                    style={{
                      clipPath: "url(#e1f94fd5-e8dd-4154-a8fb-96e4b94fae9d)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#b6dbe08e-f00e-48ee-92b0-7f9ca9311791)",
                      }}
                    >
                      <image
                        width="56"
                        height="56"
                        transform="translate(164.64 196.32) scale(0.48)"
                ...
                <g
                  id="bubble8"
                  className="bubble8Anim1"
                  ref={(el) => (bubble8Anim1 = el)}
                  data-name="8"
                >
                  <g
                    style={{
                      clipPath: "url(#e843966a-0f71-4ee6-833b-1428ad798fae)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#bb63bc3f-f444-4db8-b975-4ecf8cd4d8ac)",
                      }}
                    >
                      <image
                        width="82"
                        height="83"
                        transform="translate(35.52 77.28) scale(0.48)"
                ...
                <g
                  id="bubble9"
                  className="bubble9Anim1"
                  ref={(el) => (bubble9Anim1 = el)}
                  data-name="7"
                >
                  <g
                    style={{
                      clipPath: "url(#a6e539fb-1373-43c5-a9fc-830e50c11563)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#e7102751-cffc-469b-93dd-04a703b88b3f)",
                      }}
                    >
                      <image
                        width="57"
                        height="57"
                        transform="translate(264.48 239.52) scale(0.48)"
                ...
                <g
                  id="bubble11"
                  className="bubble11Anim1"
                  ref={(el) => (bubble11Anim1 = el)}
                  data-name="5"
                >
                  <g
                    style={{
                      clipPath: "url(#f329aa81-4401-443a-8edd-eda867cf3faf)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#ab868cb3-2278-4a94-8c9a-3d2e8e6682e5)",
                      }}
                    >
                      <image
                        width="47"
                        height="47"
                        transform="translate(36 232.8) scale(0.48)"
                ...
                <g
                  id="bubble12"
                  className="bubble12Anim1"
                  ref={(el) => (bubble12Anim1 = el)}
                  data-name="4"
                >
                  <g
                    style={{
                      clipPath: "url(#a8b3c531-4800-4fa7-8e6b-7c93af7ac366)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#b34c1b5b-dc78-465b-9f5f-d9b9896d3657)",
                      }}
                    >
                      <image
                        width="61"
                        height="61"
                        transform="translate(253.92 4.32) scale(0.48)"
                ...
                <g
                  id="bubble14"
                  className="bubble14Anim1"
                  ref={(el) => (bubble14Anim1 = el)}
                  data-name="2"
                >
                  <g
                    style={{
                      clipPath: "url(#e416c6fc-9e73-4ffa-b311-731ce35f3208)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#f6e009af-8eb6-4b07-ab1f-8e0f9e8ebf45)",
                      }}
                    >
                      <image
                        width="63"
                        height="63"
                        transform="translate(249.12 135.84) scale(0.48)"
                ...
                <g
                  id="bubble15"
                  className="bubble15Anim1"
                  ref={(el) => (bubble15Anim1 = el)}
                  data-name="1"
                >
                  <g
                    style={{
                      clipPath: "url(#a175f790-81a9-4634-b0ce-5161332adf56)",
                    }}
                  >
                    <g
                      style={{
                        clipPath: "url(#aebeb1e5-e234-4597-8d0d-525ee31aa038)",
                      }}
                    >
                      <image
                        width="50"
                        height="49"
                        transform="translate(46.08) scale(0.48)"
      ...
      <NavLink smooth to={"/#AboutSect"} activeClassName="current">
        <svg
          id="downarow"
          className=" w-16 lg:w-8  mb-10 -mr-1 mt-80 animate-bounce"
          viewBox="0 0 20 20"
          fill="white"
        >
          <path
