            ...
            <div class="w-full flex flex-col lg:flex-row flex-wrap">
                ...
                <div class="w-full pt-10 bg-red lg:w-2/3 flex flex-col">
                    ...
                    <div id="left" class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-44">
                        <h1 class="bodyheadercol text-left text-6xl lg:text-4xl font-extrabold">About Me</h1>
                        <h2 class="text-left text-4xl lg:text-2xl py-3 italic" > I value Overcoming Challenges, Continuously Learning & Creating  </h2>
                        <p class="text-left text-3xl lg:text-xl"> I obtained a Master’s degree (First Class Honours) in Chemical Engineering (MEng) from Imperial College London in 2021. Following my graduation, I decided to begin training with futureproof to upskill as a Full Stack Developer in order to kick-start my career in coding. Since October 2021, I have spent my time implementing digital innovation for Apollo as part of a small group focussed on digital innovation using Artificial Intelligence and Machine Learning. I have managed projects set to solve complex business problems and process transformations with the ultimate goal of significant financial benefits, while responding directly to specific business requirements, problems and inefficiencies. 
                        <br></br><br></br>
                        I am specialized in Deep Learning; with experience building neural network architectures such as CNN’s, Residual networks, U-Nets, RNN’s, GRU’s, LSTMs, Transformers, and have Implemented Industry best-practises for building deep learning applications effectively. By applying these concepts and understanding their industry applications using Python and TensorFlow, I have tackled real-world problems. Aside from programming and painting, I love to dance, hit the gym, complete obstacle courses, and manage my investment portfolio.
                        </p>
